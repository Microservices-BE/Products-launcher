...
``` kubectl create deployment client-gateway --image=southamerica-east1-docker.pkg.dev/microservicio-tienda-428315/image-registry/client-gateway --dry-run=client -o yaml > deployment.yml
```
